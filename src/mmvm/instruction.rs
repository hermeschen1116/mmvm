...
mod tests {
    ...
    fn test_decode_jump_instruction() {
        let testcases = [
	        ...
	        (0x00cc, &[0xff, 0xd3, 0x00, 0x00, 0x00, 0x00], 2, "call\tbx"),
	        (0x0071, &[0xff, 0xd3, 0x00, 0x00, 0x00, 0x00], 2, "call\tbx"),
	        (0x0089, &[0xff, 0xd3, 0x00, 0x00, 0x00, 0x00], 2, "call\tbx"),
	        (0x1254, &[0xff, 0xd3, 0x00, 0x00, 0x00, 0x00], 2, "call\tbx"),
	        (0x0063, &[0xff, 0xd3, 0x00, 0x00, 0x00, 0x00], 2, "call\tbx"),
	        (0x007b, &[0xff, 0xd3, 0x00, 0x00, 0x00, 0x00], 2, "call\tbx"),
	        (0x1246, &[0xff, 0xd3, 0x00, 0x00, 0x00, 0x00], 2, "call\tbx"),
	        (0x0064, &[0xff, 0xd3, 0x00, 0x00, 0x00, 0x00], 2, "call\tbx"),
	        (0x007c, &[0xff, 0xd3, 0x00, 0x00, 0x00, 0x00], 2, "call\tbx"),
	        (0x005a, &[0xff, 0xd3, 0x00, 0x00, 0x00, 0x00], 2, "call\tbx"),
	        (0x0072, &[0xff, 0xd3, 0x00, 0x00, 0x00, 0x00], 2, "call\tbx"),
	        (0x123d, &[0xff, 0xd3, 0x00, 0x00, 0x00, 0x00], 2, "call\tbx"),
	        (0x0076, &[0xff, 0xd3, 0x00, 0x00, 0x00, 0x00], 2, "call\tbx"),
	        (0x008e, &[0xff, 0xd3, 0x00, 0x00, 0x00, 0x00], 2, "call\tbx"),
	        ...
	        (0x114a, &[0xff, 0xe3, 0x00, 0x00, 0x00, 0x00], 2, "jmp\tbx"),
	        (0x1141, &[0xff, 0xe3, 0x00, 0x00, 0x00, 0x00], 2, "jmp\tbx"),
